...
public class KrakenMotor implements MotorIO {
   ...
   */
  public KrakenMotor(CANDeviceDetails details, String busname, MotorConfigs config) {
    this.config = config;
   ...
   * @return The updated {@code KrakenMotor} instance for method chaining.
   */
  public KrakenMotor withLimits(SoftwareLimitSwitchConfigs cfgLimits) {
