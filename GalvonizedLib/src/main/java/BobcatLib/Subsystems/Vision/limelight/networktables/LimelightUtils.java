package BobcatLib.Subsystems.Vision.limelight.networktables;
...
public class LimelightUtils {
  ...
  /**
   * Sanitize the {@link Limelight} name
   *
   * @param name Limelight name
   * @return {@link Limelight#limelightName} or "limelight"
   */
   ...
   *
   * @param tableName {@link Limelight#limelightName}
   * @param request URI to request from {@link Limelight}
   * @return {@link URL} to request for {@link Limelight}
   */
  ...
  /**
   * Takes a 6-length array of pose data and converts it to a {@link Pose3d} object. Array format:
   * [x, y, z, roll, pitch, yaw] where angles are in degrees.
   *
  ...
  /**
   * Takes a 6-length array of {@link Pose2d} data and converts it to a {@link Pose2d} object. Uses
   * only x, y, and yaw components, ignoring z, roll, and pitch. Array format: [x, y, z, roll,
  ...
  /**
   * Takes a 3-length array of {@link Translation3d} data and converts it into a {@link
   * Translation3d}. Array format: [x, y, z]
   *
  ...
  /**
   * Takes a 6-length array of {@link Orientation3d} data and converts it into a {@link
   * Orientation3d}. Array format: [yaw,yawrate,pitch,pitchrate,roll,rollrate]
   *
   * @param orientation Array containing {@link Orientation3d}
   *     [yaw,yawrate,pitch,pitchrate,roll,rollrate] in Degrees.
   * @return {@link Orientation3d}
   */
  public static Orientation3d toOrientation(double[] orientation) {
    return new Orientation3d(
        new Rotation3d(
            Degrees.of(orientation[4]), Degrees.of(orientation[2]), Degrees.of(orientation[0])),
  ...
  /**
   * Converts an {@link Orientation3d} to a 6-length array of
   * [yaw,yawrate,pitch,pitchrate,roll,rollrate] in Degrees.
   *
  ...
  /**
   * Converts a {@link Pose3d} object to an array of doubles in the format [x, y, z, roll, pitch,
   * yaw]. Translation components are in meters, rotation components are in degrees.
   *
  ...
  /**
   * Converts a {@link Pose2d} object to an array of doubles in the format [x, y, z, roll, pitch,
   * yaw]. Translation components are in meters, rotation components are in degrees. Note: z, roll,
   * and pitch will be 0 since {@link Pose2d} only contains x, y, and yaw.
   *
  ...
  /**
   * Converts a {@link Translation3d} object to an array of doubles in format [x, y, z].
